...
/* harmony import */ var _videos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./videos */ "./js/videos.js");
...
function (_React$Component) {
  ...
  function VideoDetail() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(VideoDetail)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      video: _videos__WEBPACK_IMPORTED_MODULE_1__["default"][0]
    };
    return _this;
  }
  ...
  _createClass(VideoDetail, [{
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, this.state.video.title), this.state.video.description && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, this.state.video.description)))));
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      setInterval(function () {
        var index = _videos__WEBPACK_IMPORTED_MODULE_1__["default"].findIndex(function (video) {
          return _this2.state.video.id == video.id;
        });

        _this2.setState({
          video: _videos__WEBPACK_IMPORTED_MODULE_1__["default"][index + 1 == _videos__WEBPACK_IMPORTED_MODULE_1__["default"].length ? 0 : index + 1]
        });
      }, 2000);
    }
  }]);
...
function (_React$Component) {
  ...
  function VideoList() {
    ...
    _this.state = {
      videos: _videos__WEBPACK_IMPORTED_MODULE_1__["default"]
    };
    return _this;
  }
  ...
  _createClass(VideoList, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        }, video.title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, video.description)));
      }))));
    }
  }, {
    key: "componentDidMount",
    value: function componentDidMount() {
      ...
      setInterval(function () {
        var index = _this2.state.videos.length + 1;
        ...
        _this2.setState({
          videos: [{
            ...
            file: "uploads/video".concat(index, ".mp4"),
            thumbnail: "uploads/thumbnails/video".concat(index, ".jpg")
          }].concat(_toConsumableArray(_this2.state.videos))
        });
      }, 5000);
    }
  }]);
...
/* harmony import */ var _VideoDetail__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./VideoDetail */ "./js/VideoDetail.js");
/* harmony import */ var _VideoList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./VideoList */ "./js/VideoList.js");




react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_VideoList__WEBPACK_IMPORTED_MODULE_3__["default"], null), document.querySelector('#appContainer'));
